...
<div style="display: block" class="container" id="nameAndPass">
	<section id="content">
		<form action="${pageContext.request.contextPath}/login" method="post">
			...
			<div>
				<input type="password" placeholder="密码" value="123" name="password" required="" id="password" />
                <br><span style="color: red">${msg2}</span>
			</div>
			<div>
				<input type="" placeholder="验证码" name="code" required="" id="code" />
			</div>
...
<p>I am the best. @YeXin Internet Bar GOGOGO  <a href="http://localhost:8080/index" target="_blank" title="网咖">野心网咖</a> </p>
</div>
